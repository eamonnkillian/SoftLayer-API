...
/* 
   ...
   This program reveals your virtual machine details for the SoftLayer platform
...
try {
    $hardware = $client->getVirtualGuests();
    echo "<h2>Current Virtual Machines</h2>";
    echo "<table>";
    foreach ($hardware as $bit) {
